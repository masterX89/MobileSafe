...
public class DragViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) ivDrag
				.getLayoutParams();// 布局的参数
		layoutParams.leftMargin = lastX;// 设置left边距
		...
		ivDrag.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mHits[mHits.length - 1] = SystemClock.uptimeMillis();// 开机后的计算时间
		...
		ivDrag.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				return false;// 事件往下传递，让onClick可以响应
			}
		});
	}
}
